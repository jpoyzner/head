//TODO: when fielding requests, needs to check for session id cookie if exists and use in ws call
//otherwise return a message to trigger login on front-end

//TODO: each request needs to return the session id and permissions back in 2 separate cookies
//session cookie needs to be http-only and and 'secure' flag when using https
//permissions cookie should be in the clear
